...
<head>
    ...
    <style>
        ...
        .button { background: #FFD700; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block; margin: 20px 0; }
    </style>
</head>
<body>
    <div class= container>
...
<?php /**PATH /var/www/mia-app/resources/views/emails/onboarding-completed.blade.php ENDPATH**/ ?>