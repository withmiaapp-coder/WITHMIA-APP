...
const pages: Record<string, PageMeta> = {
  ...
  "changelog-v100": {
    ...
    description: "Primera versión estable de WITHMIA: CRM omnicanal con IA conversacional, inbox unificado, WhatsApp Business y más de 30 integraciones.",
    breadcrumb: ["Docs", "Changelog", "v1.0.0"],
    toc: [
      { id: "core-platform", label: "Plataforma core" },
      { id: "conversations-inbox", label: "Inbox omnicanal" },
      { id: "crm-contacts", label: "CRM y contactos" },
      { id: "ai-engine", label: "Motor de IA" },
      { id: "rag-knowledge", label: "Base de conocimiento (RAG)" },
      { id: "channels-v1", label: "Canales soportados" },
      { id: "whatsapp-evolution", label: "WhatsApp Business" },
      { id: "calendar-hub", label: "Hub de calendarios" },
      { id: "products-sales", label: "Productos y ventas" },
      { id: "teams-members", label: "Equipos y miembros" },
      { id: "notifications-realtime", label: "Notificaciones en tiempo real" },
      { id: "onboarding-v1", label: "Onboarding guiado" },
      { id: "billing-v1", label: "Suscripciones y facturación" },
      { id: "admin-panel", label: "Panel de administración" },
      { id: "integrations-v1", label: "Integraciones" },
      { id: "security-infra", label: "Seguridad e infraestructura" },
      { id: "api-sdks", label: "API y SDKs" },
    ],
    readTime: "10 min", lastUpdated: "28 Ene 2026",
  },
};
...
const richContent: Record<string, ContentBlock[]> = {
  ...
  /* ── Changelog v1.0.0 ── */
  "changelog-v100": [
    { type: "callout", variant: "info", title: "Lanzamiento inicial", text: "v1.0.0 fue la primera versión estable de WITHMIA, desplegada en enero de 2026. Incluye la plataforma completa de comunicación omnicanal con IA, desde el CRM hasta integraciones con más de 7 proveedores de calendario y múltiples canales de mensajería." },

    { type: "heading", id: "core-platform", text: "Plataforma core" },
    { type: "p", text: "La base de WITHMIA: un dashboard centralizado con todas las herramientas para gestionar la comunicación de tu empresa desde un solo lugar." },
    { type: "list", items: [
      "Dashboard principal con métricas en tiempo real — conversaciones activas, tiempos de respuesta, rendimiento del equipo",
      "Sistema multi-workspace — cada empresa tiene su propio espacio aislado con facturación independiente",
      "Roles y permisos granulares — Admin, Supervisor, Agente y Viewer con acceso diferenciado",
      "Modo oscuro nativo — interfaz completa optimizada para uso prolongado",
      "Citas diarias inspiracionales — frases motivacionales en el dashboard con personajes históricos",
      "Pantalla de transición animada — loading screen con branding durante la carga de la app",
      "Error boundary global — manejo graceful de errores sin pérdida de sesión",
    ]},

    { type: "heading", id: "conversations-inbox", text: "Inbox omnicanal unificado" },
    { type: "p", text: "El corazón de WITHMIA: un inbox que centraliza todas las conversaciones de todos los canales en una sola interfaz, con herramientas profesionales de gestión." },
    { type: "list", items: [
      "Inbox unificado — WhatsApp, Instagram, Messenger, Email y Webchat en una sola vista",
      "Lista de conversaciones con búsqueda en tiempo real y filtros avanzados",
      "Panel de chat completo con burbujas de mensaje, timestamps y estado de entrega",
      "Asignación automática — round robin, carga mínima o asignación manual por supervisor",
      "Sistema de etiquetas con colores personalizables para organizar conversaciones",
      "Prioridades — baja, normal, alta y urgente con indicadores visuales",
      "Estados de conversación — abierta, resuelta, pendiente, suspendida",
      "Respuestas rápidas (canned responses) — plantillas reutilizables para agilizar respuestas",
      "Envío de multimedia — imágenes, videos, documentos, audio y ubicación",
      "Drag & drop de archivos directamente en el área de chat",
      "Message Templates de WhatsApp — envío de plantillas pre-aprobadas por Meta",
      "Estado de mensajes en tiempo real — enviado, entregado, leído (doble check azul)",
      "Detección y merge de conversaciones duplicadas automáticamente",
      "Notas internas en contactos — visibles solo para el equipo",
    ]},

    { type: "heading", id: "crm-contacts", text: "CRM y contactos" },
    { type: "p", text: "Gestión completa de contactos integrada directamente con el inbox, sin necesidad de herramientas externas." },
    { type: "list", items: [
      "Base de contactos centralizada con perfiles unificados por canal",
      "Campos personalizados — email, teléfono, empresa, notas, etc.",
      "Pipeline visual — etapas configurables para seguimiento de oportunidades",
      "Exportación a Excel dinámico — descarga de contactos con formato profesional",
      "Búsqueda y segmentación avanzada de contactos",
      "Historial de conversaciones por contacto a través de todos los canales",
    ]},

    { type: "heading", id: "ai-engine", text: "Motor de IA" },
    { type: "p", text: "IA conversacional de nivel empresarial que atiende clientes 24/7 con contexto de tu negocio, y transfiere a humanos cuando es necesario." },
    { type: "list", items: [
      "Asistente IA conversacional basado en OpenAI GPT-4",
      "Personalidad configurable — tono, idioma, límites y comportamiento del bot",
      "Memoria de conversación — el bot recuerda el contexto dentro de cada chat",
      "Handoff inteligente — transferencia automática a agente humano con contexto completo",
      "Respuestas sugeridas — la IA sugiere respuestas al agente en tiempo real",
      "Flujos automáticos con lógica condicional y triggers",
      "Transcripción de audio con OpenAI Whisper — convierte notas de voz a texto",
      "Chat de entrenamiento interactivo — prueba y ajusta el bot antes de ponerlo en producción",
      "Configuración por empresa — cada workspace tiene su propio asistente independiente",
    ]},

    { type: "heading", id: "rag-knowledge", text: "Base de conocimiento (RAG)" },
    { type: "p", text: "Retrieval-Augmented Generation: alimenta al bot con documentos de tu empresa para que responda con precisión basada en datos reales." },
    { type: "list", items: [
      "Subida de documentos — PDFs, Word, TXT, Markdown, CSV, Excel",
      "Procesamiento automático — divide documentos en fragmentos y genera embeddings vectoriales",
      "Almacenamiento vectorial con Qdrant — búsqueda semántica de alta velocidad",
      "Gestión de puntos vectoriales — ver, editar y eliminar embeddings individuales",
      "Procesamiento via n8n — workflow RAG dedicado para cada empresa",
      "Una colección Qdrant por empresa — aislamiento total de datos entre workspaces",
      "Playground de pruebas — haz preguntas y verifica las respuestas antes de activar",
    ]},

    { type: "heading", id: "channels-v1", text: "Canales soportados" },
    { type: "p", text: "Cinco canales de comunicación integrados nativamente, todos gestionados desde el mismo inbox." },
    { type: "list", items: [
      "WhatsApp Business API — via Evolution API con conexión QR y multi-instancia",
      "Instagram Direct Messages — DMs y respuestas a stories desde el inbox",
      "Facebook Messenger — mensajes de páginas de Facebook",
      "Chat Web — widget embebible en cualquier sitio web, personalizable",
      "Email — IMAP/SMTP para gestionar correos como conversaciones",
      "WhatsApp Cloud API — conexión alternativa directa via Meta",
      "Creación de canales OAuth — flujo guiado para Facebook, Instagram y WhatsApp Cloud",
    ]},

    { type: "heading", id: "whatsapp-evolution", text: "WhatsApp Business (Evolution API)" },
    { type: "p", text: "Integración profunda con WhatsApp via Evolution API, permitiendo múltiples números por empresa y conexión sin Meta Business Suite." },
    { type: "list", items: [
      "Conexión por código QR — escanea y conecta en segundos desde el dashboard",
      "Multi-instancia — varias líneas de WhatsApp por empresa",
      "Sincronización automática con Chatwoot — mensajes bidireccionales en tiempo real",
      "Estado de conexión en vivo — indicador visual de connected/disconnected",
      "Envío de mensajes de texto, imágenes, videos, documentos y audio",
      "Reconexion automática si la instancia se desconecta",
      "Webhook bridge — reenvío de mensajes entrantes a n8n para procesamiento IA",
    ]},

    { type: "heading", id: "calendar-hub", text: "Hub de calendarios" },
    { type: "p", text: "WITHMIA integra 7 proveedores de calendario diferentes, todos accesibles para el bot vía un endpoint unificado para consultar disponibilidad y agendar citas." },
    { type: "list", items: [
      "Google Calendar — OAuth, CRUD de eventos, consulta de disponibilidad para el bot",
      "Outlook Calendar — OAuth con Microsoft, eventos y disponibilidad",
      "Calendly — tipos de evento y links de agendamiento via bot",
      "Reservo — servicios, disponibilidad y reservas directas",
      "AgendaPro — locaciones, servicios y reservas",
      "Dentalink — sucursales, dentistas, tratamientos y citas para clínicas dentales",
      "Medilink — sucursales, profesionales, especialidades y citas para clínicas médicas",
      "CalendarHub unificado — endpoint único que agrega todos los proveedores para n8n",
    ]},

    { type: "heading", id: "products-sales", text: "Productos y ventas" },
    { type: "p", text: "Catálogo de productos integrado con seguimiento de ventas y acceso directo desde el bot para mostrar productos y generar links de compra." },
    { type: "list", items: [
      "Catálogo de productos — CRUD completo con imágenes, categorías y precios",
      "Integración WooCommerce — sincroniza productos desde tu tienda WordPress",
      "Búsqueda de productos via bot — el asistente IA muestra productos y genera links de compra",
      "Registro de ventas — tracking de compras iniciadas por el bot",
      "Estadísticas de ventas — métricas de conversión y revenue",
      "Plugin WordPress descargable — instalador para conectar WooCommerce",
    ]},

    { type: "heading", id: "teams-members", text: "Equipos y miembros" },
    { type: "p", text: "Gestión completa de equipos con invitaciones por email, roles diferenciados y sincronización con Chatwoot." },
    { type: "list", items: [
      "Invitaciones por email — sistema de invitación con validación y expiración",
      "Roles por miembro — Admin, Supervisor, Agente, Viewer",
      "Equipos (Teams) — crea grupos temáticos para asignar conversaciones",
      "Sincronización de agentes con Chatwoot — creación automática de agentes al unirse",
      "Login con Google — SSO via Google OAuth para todo el equipo",
      "Eliminación completa de usuario — cascade cleanup en todos los servicios conectados",
    ]},

    { type: "heading", id: "notifications-realtime", text: "Notificaciones en tiempo real" },
    { type: "p", text: "Sistema de notificaciones push con Laravel Reverb (WebSocket) para alertar al equipo instantáneamente." },
    { type: "list", items: [
      "Notificaciones en tiempo real via WebSocket (Laravel Reverb)",
      "Campana de notificaciones con badge de no leídas",
      "Toast notifications — alertas flotantes para mensajes nuevos y cambios de estado",
      "Centro de notificaciones — historial completo de alertas",
      "Eventos broadcast — NewMessageReceived, ConversationAssigned, ConversationUpdated, MessageUpdated, WhatsAppStatusChanged",
      "Sonidos de notificación configurables",
      "Preferencias por usuario — activa/desactiva tipos de notificación",
    ]},

    { type: "heading", id: "onboarding-v1", text: "Onboarding guiado" },
    { type: "p", text: "Wizard de configuración paso a paso que provisiona automáticamente todos los servicios necesarios para una nueva empresa." },
    { type: "list", items: [
      "Wizard multi-step — datos de empresa, conexión WhatsApp, configuración del bot",
      "Búsqueda automática de datos de empresa via Google",
      "Provisionamiento automático — crea cuenta Chatwoot, colección Qdrant, workflows n8n y bot en un solo paso",
      "Job asíncrono (PostOnboardingSetupJob) — setup completo en background sin bloquear la UI",
      "Validación y retries — manejo de errores con reintentos automáticos",
    ]},

    { type: "heading", id: "billing-v1", text: "Suscripciones y facturación" },
    { type: "p", text: "Sistema de planes y facturación integrado con dLocal GO para pagos en Latinoamérica." },
    { type: "list", items: [
      "Planes Starter, Growth y Enterprise con features diferenciadas",
      "Checkout integrado con dLocal GO — tarjetas, transferencias y métodos locales",
    ...
    { type: "p", text: "Panel exclusivo para administradores de la plataforma con visibilidad total y herramientas de mantenimiento." },
    { type: "list", items: [
      "Dashboard de superadmin — estadísticas globales de la plataforma",
      "Gestión de usuarios — ver, editar y eliminar usuarios de toda la plataforma",
      "Gestión de empresas — monitoreo de todos los workspaces activos",
      "Tickets de soporte — administración centralizada de tickets de clientes",
      "Health check — estado de servicios externos (Chatwoot, Qdrant, n8n, Evolution)",
      "Reparación de Qdrant — herramientas para rebuild de colecciones vectoriales",
      "Diagnóstico de bots — debug del estado y configuración del bot por empresa",
      "Migración de webhooks — herramienta para actualizar endpoints",
    ]},

    { type: "heading", id: "integrations-v1", text: "Integraciones" },
    { type: "p", text: "Ecosistema de integraciones que conecta WITHMIA con las herramientas que tu equipo ya usa." },
    { type: "list", items: [
      "n8n — motor de workflows con templates pre-configurados (bot template, RAG processor, training chat)",
      "Chatwoot — motor de conversaciones con provisionamiento automático",
      "Qdrant — base de datos vectorial para RAG y búsqueda semántica",
      "Google Calendar + Outlook Calendar + Calendly — agendamiento via bot",
      "Reservo + AgendaPro + Dentalink + Medilink — reservas especializadas por industria",
      "WooCommerce — sincronización de catálogo y ventas via bot",
      "Google OAuth — autenticación SSO para usuarios y equipos",
      "dLocal GO — procesamiento de pagos para Latinoamérica",
      "Plugins WordPress descargables — WooCommerce bridge y ChatWeb widget",
    ]},

    { type: "heading", id: "security-infra", text: "Seguridad e infraestructura" },
    { type: "p", text: "Arquitectura robusta desplegada en Railway con servicios aislados y seguridad en múltiples capas." },
    { type: "list", items: [
      "Despliegue automático en Railway — cada push a main dispara build y deploy",
      "Laravel Octane — servidor de alto rendimiento con RoadRunner",
      "Laravel Reverb — WebSocket server para real-time (servicio independiente)",
      "Redis — cache, colas y sesiones",
      "Laravel Horizon — monitoreo de colas de jobs",
      "Proxy seguro de media — imágenes y archivos de Chatwoot proxeados para seguridad",
      "CORS configurado — acceso controlado desde dominios autorizados",
      "Rate limiting — protección contra abuso en endpoints públicos",
      "Healthcheck en /up — monitoreo de disponibilidad",
      "Sentry — monitoreo de errores en producción",
    ]},

    { type: "heading", id: "api-sdks", text: "API y SDKs" },
    { type: "p", text: "API RESTful completa con documentación y SDKs oficiales para las principales plataformas." },
    { type: "list", items: [
      "API RESTful — 39 controllers con más de 200 endpoints",
      "Autenticación Sanctum — tokens seguros para API",
      "SDK Node.js — @withmia/sdk con TypeScript nativo",
      "SDK Python — cliente oficial con soporte async",
      "SDK PHP — compatible con Laravel y frameworks PHP",
      "Webhooks bidireccionales — recibe y envía eventos en tiempo real",
      "Documentación interactiva — página de docs con ejemplos de código en 3 lenguajes",
    ]},
  ],
};
