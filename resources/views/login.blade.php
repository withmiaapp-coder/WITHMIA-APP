        ...
        <div class="left-panel" style="display:none !important">
            <div class="eco-section">
                ...
                <div class="eco-orbit">
                    ...
                    <!-- Connection lines SVG — viewBox 0 0 100 100 maps directly to CSS % positions -->
                    <svg class="eco-lines" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <defs>
                            <linearGradient id="lg0" x1="50" y1="50" x2="50" y2="30" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#a78bfa" stop-opacity="0.5"/><stop offset="100%" stop-color="#25D366" stop-opacity="0.7"/></linearGradient>
                            <linearGradient id="lg1" x1="50" y1="50" x2="64" y2="38.8" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#a78bfa" stop-opacity="0.5"/><stop offset="100%" stop-color="#E1306C" stop-opacity="0.7"/></linearGradient>
                            <linearGradient id="lg2" x1="50" y1="50" x2="64" y2="61.2" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#a78bfa" stop-opacity="0.5"/><stop offset="100%" stop-color="#0084FF" stop-opacity="0.7"/></linearGradient>
                            <linearGradient id="lg3" x1="50" y1="50" x2="50" y2="70" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#a78bfa" stop-opacity="0.5"/><stop offset="100%" stop-color="#EA4335" stop-opacity="0.7"/></linearGradient>
                            <linearGradient id="lg4" x1="50" y1="50" x2="36" y2="61.2" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#a78bfa" stop-opacity="0.5"/><stop offset="100%" stop-color="#61DAFB" stop-opacity="0.7"/></linearGradient>
                            <linearGradient id="lg5" x1="50" y1="50" x2="36" y2="38.8" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#a78bfa" stop-opacity="0.5"/><stop offset="100%" stop-color="#34D399" stop-opacity="0.7"/></linearGradient>
                        </defs>
                        <!-- Center(50,50) → channel lines (coords = CSS top%/left%) -->
                        <line x1="50" y1="50" x2="50" y2="30" stroke="url(#lg0)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-dasharray="4 5" style="animation:dashFlow 4s linear infinite"/>
                        <line x1="50" y1="50" x2="64" y2="38.8" stroke="url(#lg1)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-dasharray="4 5" style="animation:dashFlow 4s linear infinite;animation-delay:.6s"/>
                        <line x1="50" y1="50" x2="64" y2="61.2" stroke="url(#lg2)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-dasharray="4 5" style="animation:dashFlow 4s linear infinite;animation-delay:1.2s"/>
                        <line x1="50" y1="50" x2="50" y2="70" stroke="url(#lg3)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-dasharray="4 5" style="animation:dashFlow 4s linear infinite;animation-delay:1.8s"/>
                        <line x1="50" y1="50" x2="36" y2="61.2" stroke="url(#lg4)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-dasharray="4 5" style="animation:dashFlow 4s linear infinite;animation-delay:2.4s"/>
                        <line x1="50" y1="50" x2="36" y2="38.8" stroke="url(#lg5)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-dasharray="4 5" style="animation:dashFlow 4s linear infinite;animation-delay:3s"/>
                        <!-- Animated particles on center→channel paths -->
                        <path id="p0" d="M50 50 L50 30" stroke="none"/><path id="p1" d="M50 50 L64 38.8" stroke="none"/><path id="p2" d="M50 50 L64 61.2" stroke="none"/><path id="p3" d="M50 50 L50 70" stroke="none"/><path id="p4" d="M50 50 L36 61.2" stroke="none"/><path id="p5" d="M50 50 L36 38.8" stroke="none"/>
                        <circle r="0.6" fill="#25D366" fill-opacity="0"><animateMotion dur="3s" repeatCount="indefinite"><mpath href="#p0"/></animateMotion><animate attributeName="fill-opacity" values="0;0.85;0.85;0" dur="3s" repeatCount="indefinite"/></circle>
                        <circle r="0.6" fill="#E1306C" fill-opacity="0"><animateMotion dur="3.2s" repeatCount="indefinite" begin="0.8s"><mpath href="#p1"/></animateMotion><animate attributeName="fill-opacity" values="0;0.85;0.85;0" dur="3.2s" repeatCount="indefinite" begin="0.8s"/></circle>
                        <circle r="0.6" fill="#0084FF" fill-opacity="0"><animateMotion dur="3.4s" repeatCount="indefinite" begin="1.6s"><mpath href="#p2"/></animateMotion><animate attributeName="fill-opacity" values="0;0.85;0.85;0" dur="3.4s" repeatCount="indefinite" begin="1.6s"/></circle>
                        ...
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="3.7s" repeatCount="indefinite" begin="2s"><mpath href="#o3"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="3.7s" repeatCount="indefinite" begin="2s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="3.9s" repeatCount="indefinite" begin="2.5s"><mpath href="#o4"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="3.9s" repeatCount="indefinite" begin="2.5s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="3.9s" repeatCount="indefinite" begin="3s"><mpath href="#o5"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="3.9s" repeatCount="indefinite" begin="3s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="4.1s" repeatCount="indefinite" begin="3.5s"><mpath href="#o6"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="4.1s" repeatCount="indefinite" begin="3.5s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="4.1s" repeatCount="indefinite" begin="4s"><mpath href="#o7"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="4.1s" repeatCount="indefinite" begin="4s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="4.3s" repeatCount="indefinite" begin="4.5s"><mpath href="#o8"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="4.3s" repeatCount="indefinite" begin="4.5s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="4.3s" repeatCount="indefinite" begin="5s"><mpath href="#o9"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="4.3s" repeatCount="indefinite" begin="5s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="4.5s" repeatCount="indefinite" begin="5.5s"><mpath href="#o10"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="4.5s" repeatCount="indefinite" begin="5.5s"/></circle>
                        <circle r="0.4" fill="#a78bfa" fill-opacity="0"><animateMotion dur="4.5s" repeatCount="indefinite" begin="6s"><mpath href="#o11"/></animateMotion><animate attributeName="fill-opacity" values="0;0.7;0.7;0" dur="4.5s" repeatCount="indefinite" begin="6s"/></circle>
                    </svg>
