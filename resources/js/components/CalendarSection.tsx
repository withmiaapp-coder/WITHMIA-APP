...
export default function CalendarSection({ user, company }: Props) {
  ...
  if (!isConnected) {
    return (
      <div className="min-h-[700px] p-6 md:p-10 overflow-y-auto">
        <div className="max-w-5xl mx-auto">
          {/* Header */}
          <div className="mb-10">
            <div className="flex items-center space-x-4 mb-2">
              <div className="p-4 bg-gradient-to-br from-rose-500 to-pink-600 rounded-2xl shadow-lg shadow-rose-200">
                <CalendarIcon className="w-10 h-10 text-white" strokeWidth={1.5} />
              </div>
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-neutral-800">Calendario</h1>
                <p className="text-base text-neutral-400 mt-1">Conecta y gestiona tus citas y eventos</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            {/* Left - Connect Card */}
            <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-200/80 shadow-lg shadow-slate-100 overflow-hidden">
              <div className="relative p-8 md:p-10">
                {/* Decorative background */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-rose-50 to-transparent rounded-bl-full opacity-60 pointer-events-none"></div>
                
                <div className="relative">
                  <div className="w-20 h-20 mb-6 bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 rounded-2xl flex items-center justify-center border border-rose-100">
                    <svg className="w-10 h-10" viewBox="0 0 48 48">
                      <path d="M36 8H12a4 4 0 00-4 4v24a4 4 0 004 4h24a4 4 0 004-4V12a4 4 0 00-4-4z" fill="#fff" stroke="#e11d48" strokeWidth="2"/>
                      <path d="M8 18h32" stroke="#e11d48" strokeWidth="2"/>
                      <rect x="14" y="22" width="6" height="6" rx="1" fill="#fecdd3"/>
                      <rect x="22" y="22" width="6" height="6" rx="1" fill="#e11d48"/>
                      <rect x="30" y="22" width="6" height="6" rx="1" fill="#fecdd3"/>
                      <rect x="14" y="30" width="6" height="6" rx="1" fill="#fecdd3"/>
                      <rect x="22" y="30" width="6" height="6" rx="1" fill="#fecdd3"/>
                      <circle cx="16" cy="6" r="2" fill="#e11d48"/>
                      <circle cx="32" cy="6" r="2" fill="#e11d48"/>
                    </svg>
                  </div>
                  ...
                  <p className="text-neutral-500 mb-8 leading-relaxed max-w-md">
                    Sincroniza tus citas, reuniones y eventos. Tu bot <span className="font-semibold text-neutral-700">MIA</span> podrá consultar tu disponibilidad 
                  ...
                  <button
                    ...
                    disabled={connecting}
                    className="inline-flex items-center gap-3 px-8 py-4 bg-white border-2 border-slate-200 rounded-2xl hover:border-rose-300 hover:shadow-xl hover:shadow-rose-100 transition-all duration-300 group disabled:opacity-50"
                  >
                    {connecting ? (
                    ...
                    <span className="text-base font-semibold text-neutral-700 group-hover:text-rose-600 transition-colors">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  <div className="p-2.5 rounded-xl bg-rose-50">
                    <CalendarIcon className="w-5 h-5 text-rose-500" strokeWidth={2} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-neutral-800 text-sm">Calendario sincronizado</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">Visualiza todos tus eventos de Google Calendar en tiempo real con vista de mes, semana o día.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  <div className="p-2.5 rounded-xl bg-purple-50">
                    <Bot className="w-5 h-5 text-purple-500" strokeWidth={2} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-neutral-800 text-sm">Asistente con acceso</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">Tu bot MIA consulta tu disponibilidad y agenda citas automáticamente desde WhatsApp.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-neutral-800 text-sm">Seguro y privado</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">Conexión OAuth 2.0 oficial de Google. Puedes desconectar en cualquier momento.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-neutral-800 text-sm">Crea eventos fácilmente</h3>
                    <p className="text-xs text-neutral-400 mt-1 leading-relaxed">Crea reuniones y citas directamente desde WITHMIA y se sincronizan con tu calendario.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-200/60 px-8 py-5">
            <p className="text-xs text-neutral-400 mb-3 font-semibold uppercase tracking-wider">Próximas integraciones</p>
            <div className="flex flex-wrap gap-2.5">
              {[
                { name: 'Outlook', icon: '📧', color: 'bg-blue-50 border-blue-100 text-blue-600' },
                { name: 'Apple Calendar', icon: '🍎', color: 'bg-slate-50 border-slate-200 text-slate-600' },
                { name: 'Calendly', icon: '📅', color: 'bg-indigo-50 border-indigo-100 text-indigo-600' },
                { name: 'Cal.com', icon: '🗓️', color: 'bg-neutral-50 border-neutral-200 text-neutral-600' },
                { name: 'Reservo', icon: '⚡', color: 'bg-amber-50 border-amber-100 text-amber-600' },
              ].map(platform => (
                <div key={platform.name} className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-medium opacity-50 ${platform.color}`}>
