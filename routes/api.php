...
Route::get('/debug/broadcast-check', function () {
    $user = \App\Models\User::with('company')->find(1);
    ...
    $reverbServerConfig = [
        ...
        'hostname' => config('reverb.servers.reverb.hostname'),
    ];
    $reverbAppConfig = [
    ...
    return response()->json([
        'user_chatwoot_inbox_id' => $user?->chatwoot_inbox_id,
        'company_chatwoot_inbox_id' => $company?->chatwoot_inbox_id,
        'company_slug' => $company?->slug,
        'broadcast_config' => $broadcastConfig,
        'reverb_server_config' => $reverbServerConfig,
        'reverb_app_config' => $reverbAppConfig,
