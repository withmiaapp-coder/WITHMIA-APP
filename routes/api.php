...
// 🐛 DEBUG TEMPORAL: Verificar conversación en Chatwoot (SIN AUTH)
Route::get('/debug-conv/{id}', function ($id) {
    try {
        // Buscar conversación SIN filtro de account
        ...
        // Verificar también el usuario autenticado si hay sesión
        $user = auth()->user();
        $userConfig = null;
        ...
        if ($user) {
            ...
            $userConfig = [
                ...
                'company_chatwoot_account_id' => $company?->chatwoot_account_id,
                'company_account_id_type' => $company ? gettype($company->chatwoot_account_id) : null,
                'config_default' => config('chatwoot.account_id')
            ];
        }
        ...
        return response()->json([
            ...
            'conversation_account_id_type' => gettype($conversation->account_id),
            'user_config' => $userConfig,
            'match' => $userConfig ? ($conversation->account_id == $userConfig['company_chatwoot_account_id']) : null
        ]);
